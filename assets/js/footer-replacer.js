...
// This script replaces the default Just the Docs footer with our custom sponsorship footer

document.addEventListener('DOMContentLoaded', function() {
  // Find the default footer
  const defaultFooter = document.querySelector('.site-footer');
  
  if (defaultFooter) {
    // Create our custom footer HTML
    ...
    // Replace the default footer content with our custom footer
    defaultFooter.innerHTML = customFooterHTML;
    
    // Add a class to the footer for styling
    defaultFooter.classList.add('custom-footer-wrapper');
  }
});
